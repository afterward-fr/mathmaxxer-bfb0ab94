-- Add practice_rating column to profiles
ALTER TABLE public.profiles
ADD COLUMN practice_rating INTEGER NOT NULL DEFAULT 1000;

-- Update the complete_game function to use practice_rating instead of iq_rating
